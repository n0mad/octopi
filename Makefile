...
bin/octopi:	bin/model_const.o bin/model_adaptive.o bin/encoder.o src/oct.cpp bin/decoder.o src/compression/bytesbits.h bin/model_gru.o bin/model_rnn.o
...
bin/test:	bin/model_const.o bin/model_adaptive.o bin/encoder.o src/test.cpp bin/decoder.o src/compression/bytesbits.h bin/model_gru.o bin/model_rnn.o
...
bin/model_gru.o: src/models/model_gru.cpp src/models/model_gru.h src/model_abstract.h src/models/json_util.h
	g++ $(CPPFLAGS) -c ./src/models/model_gru.cpp -o ./bin/model_gru.o

bin/model_rnn.o: src/models/model_rnn.cpp src/models/model_rnn.h src/model_abstract.h src/models/json_util.h
